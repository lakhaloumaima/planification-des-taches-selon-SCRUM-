...
import { Create, DeletePro, DeleteTache, GetProjectByclient, GetProjectByid, GetProjectBymaster, GetProjects, UpdateProject } from "./projectAPI";
...
export const getprojectbymaster = createAsyncThunk("getprojectbymaster", async (data) => {
  const response = await GetProjectBymaster(data);
  console.log("project by master : " + response.data)
  return response.data;
});
//get project by id
...
builder.addCase(getprojects.pending, (state, action) => {
  ...
  /*builder.addCase(getprojectbyclient.fulfilled, (state, action) => {
    console.log(action.payload);
   state.projectsmasters = action.payload.data;
  });
  */
  builder.addCase(getprojectbyclient.fulfilled, (state, action) => {
    console.log(action.payload);
  ...
  builder.addCase(getprojectbymaster.fulfilled, (state, action) => {
    console.log(action.payload);
   state.masterprojects.projectsmaster = action.payload.data;
  });
   /////////update project
...
// export const selectprojectsmasters = (state) => state.projects.projectsmasters;
...
export const selectprojectmaster = (state) => state.projects.masterprojects.projectsmaster;
